<?php define('usemainjs',false);define('dotdotcnt',3); define('bodyClass',''); define('titleExtend','Privacy Policy');define('footerFixed',false); require_once('./../static/Content/head.php'); ?>
<div class="container-fluid">
    <div class="card">
        <!---->
        <div class="card-title">
            <h1 style="margin-top: 10px;margin-left: 10px;">Privacy Policy</h1>
        </div>
        <div class="tucupampam card-body" style="z-index: 100;">
            <p>Updated at 2021-10-11</p>
            <p style="display: inline;"> Days Web App</p>
            ...
            <p style="display: inline;"> Days Web App.</p> <br>
            <div style="display: inline;">
                <p style="display: inline;"><span class="s1">This Privacy Policy applies to our website,</span></p>
                <p style="display: inline;"><span class="s1"> nawin.com/days</span></p>
            ...
            <ul class="ul1">
                ...
                <!---->
                <li class="li8"><span class="s1"><strong>Company:</strong> when this policy mentions “Company,” “we,” “us,” or “our,” it refers to <a>Days Web App</a> that is responsible for your information under this Privacy Policy.<br></span></li>
                ...
                <li class="li8"><span class="s1"><strong>Customer:</strong> refers to the company, organization or person that signs up to use the <a>Days Web App</a> Service to manage the relationships with your consumers or service users.<br></span></li>
                ...
                <li class="li8"><span class="s1"><strong>Personnel:</strong> refers to those individuals who are employed by <a>Days Web App</a> or are under contract to perform a service on behalf of one of the parties.<br></span></li>
            ...
            <ul class="ul1">
                <li class="li11"><span class="s3">Location (GPS): <strong>Location data</strong> Location data helps to create an accurate representation of your interests, and this can be used to bring more targeted and relevant ads to potential customers.</span></li>
                ...
                <li class="li11"><span class="s3">Camera (Pictures): Granting <strong>camera permission</strong> allows the user to upload any picture straight from our service. You can safely deny camera permissions for our service.</span></li>
                <li class="li11"><span class="s3">Photo Gallery (Pictures): Granting <strong>photo gallery access</strong> allows the user to upload any picture from their photo gallery, you can safely deny photo gallery access for our service.</span></li>
            </ul>
            <p class="p3"><br></p>
...
We may also disclose personal and non-personal information about you to government or law enforcement officials or private parties as we, in our sole discretion, believe necessary or appropriate in order to respond to claims, legal process (including subpoenas), to protect our rights and interests or those of a third party, the safety of the public or any person, to prevent or stop any illegal, unethical, or legally actionable activity, or to otherwise comply with applicable court orders, laws, rules and regulations.
            ...
            <p class="p10"><span class="s1">We are incorporated in Thailand. Information collected via our website, through direct interactions with you, or from use of our help services may be transferred from time to time to our offices or personnel, or to third parties, located throughout the world, and may be viewed and hosted anywhere in the world, including countries
...
Corporate Affiliates to which the Service relates, or in the event that we discontinue our business or file a petition or have filed against us a petition in bankruptcy, reorganization or similar proceeding, provided that the third party agrees to adhere to the terms of this Privacy Policy.</span></p>
            ...
            <p class="p3"><br></p>
            <h1>Governing Law</h1>
            <p class="p10"><span class="s1">The laws of Thailand, excluding its conflicts of law rules, shall govern this Agreement and your use of our service. Your use of our service may also be subject to other local, state, national, or international laws.</span></p>
            <p class="p3"><br></p>
            <h1>Your Consent</h1>
...
own rules and policies. Such third parties may use their own cookies or other methods to collect information about you.</span></p>
            ...
            <p class="p10"><span class="s1">We use remarketing services. What Is Remarketing? In digital marketing, remarketing (or retargeting) is the practice of serving ads across the internet to people who have already visited your website. It allows your company to seem like they're “following” people around the internet by serving ads on the websites and platforms they use most.</span></p>
            <p class="p15"><br></p>
            ...
            <p class="p10"><span class="s1">Facebook pixel is an analytics tool that allows you to measure the effectiveness of your advertising by understanding the actions people take on your website. You can use the pixel to: Make sure your ads are shown to the right people. Facebook pixel may collect
